...
| 3. Integraciones / Orquestación | Cuando exista la necesidad de revisar/consumir/validar una regla almacenada en el repositorio, se podrá hacer mediante integraciones| Transportar datos pertinentes de la decisión arquitectónica. |
...
> Agregar nuevos riesgos al final, sin importar la numeración.
...
| Fecha | Cambio | Autor |
|---|---|---|
| 2026-07-07 | Creación del ADR | Daniel Cuevas |
